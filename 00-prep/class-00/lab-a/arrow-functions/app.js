...
const oldObject = array => { return { firstValue: array[0], secondValue: array[1], thirdValue: array[3] };};
...
// when an arrow function is used, the scope of the function bubbles up to the next-nearest scope
